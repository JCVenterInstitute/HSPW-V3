...
def parseInput():
    ...
    parser.add_argument(
        "-l", "--logNormalized", dest="log_normalized", type=str, help="Log Normalized?"
    )
    parser.add_argument(
        "-f", "--foldThreshold", dest="fold_threshold", type=str, help="Fold Threshold"
    )
    ...
    parser.add_argument(
        "-t", "--statTest", dest="stat_test", type=str, help="Stat Test"
    )
    parser.add_argument(
        "-n",
        "--heatMap",
        dest="heat_map_number",
        type=str,
        help="Number of proteins in heatmap",
    )
