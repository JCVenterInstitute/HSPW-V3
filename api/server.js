...
const customDomainReroute =
  require("@turinggroup/serverless-express-custom-domain-middleware").customDomainReroute;
...
const createServer = () => {
  ...
  // This middleware will manage handling of the /didact custom domain
  // path, because the express server is expecting requests to come
  // from /project and not /didact/project or /didact/search-term
  ...
  app.get("/api/hsp/ping", (req, res) => {
    res.status(200).json({ Message: "HSP Api Pinged!" });
  });
