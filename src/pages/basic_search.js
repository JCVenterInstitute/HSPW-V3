  ...
  render() { 
    ...
    return (
      ...
      /> <button onClick={this.add}>Click to add</button>
        ...
        <input type="submit" value="+" style={{width:'30px'}} onClick={this.add}></input>
        <input type="submit" value="-" style={{width:'30px'}} onClick={this.delete}></input>

        <form  onSubmit={this.handleSubmit}>

          <div className="button-section">
              <button className="button add" type="button" onClick={this.add1}>Add</button>
    ...
    <form style={{marginTop:'30px',marginLeft:'20px', fontSize:'18px'}}>
        <table style={{width:'90%', borderSpacing:'4px',tableLayout:'fixed',margin:'10px'}}>
            <caption style={{margin:'10px'}}>
                Search For  
                <select name="displayAll" value={this.state.categories} onChange = {e=>this.setState({categories:e.target.value})} style={{marginLeft:'5px',marginRight:'5px',
          minHeight: '23px'}}>
            ...
            <div className="second-division">
              ...
              <tr style={{marginLeft:'20px',marginTop:'20px',textAlign:'left',width:'64px',whiteSpace:'nowrap'}}>
                  ...
                  <td style={{width:'100%'}}>
                    ...
                    <Select options={this.state.geneOption} styles={this.customStyles} defaultValue={this.state.geneOption[0]}/>
                    : null
                    }
