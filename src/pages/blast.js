    ...
    <>
      ...
      <div style={{ height: "40%", backgroundImage: `url(${main_feature})` }}>
        ...
        >
          ...
          similarity between sequences. Position Specific Iterative BLAST
          (PSI-BLAST) performs an iterative sequence similarity search which can
          detect more distant evolutionary relationships. This service is
      ...
      <form style={{ marginTop: "30px", marginLeft: "20px" }}>
          ...
          <tr style={{ marginBottom: "20px" }}>
            <td>
              ...
              <select id="database" name="database">
                <option value="uniprotkb">
                  UniProt Knowledgebase (The UniProt Knowledgebase includes
                  UniProtKB/Swiss-Prot and UniProtKB/TrEMBL)
                </option>
                <option value="uniprotkb_swissprot">
                  UniProtKB/Swiss-Prot (The manually annotated section of
                  UniProtKB)
                </option>
                <option value="uniprotkb_swissprotsv">
                  UniProtKB/Swiss-Prot isoforms (The manually annotated isoforms
                  of UniProtKB/Swiss-Prot)
                </option>
                <option value="uniprotkb_trembl">
                  UniProtKB/TrEMBL (The automatically annotated section of
                  UniProtKB)
                </option>
                <option value="uniprotkb_refprotswissprot">
                  UniProtKB Reference Proteomes plus Swiss-Prot
                </option>
                <option value="uniprotkb_archaea">UniProtKB Archaea</option>
                <option value="uniprotkb_arthropoda">
                  UniProtKB Arthropoda
                </option>
                <option value="uniprotkb_bacteria">UniProtKB Bacteria</option>
                <option value="uniprotkb_complete_microbial_proteomes">
                ...
                <option value="uniprotkb_reference_proteomes">
                  UniProtKB Reference Proteomes
                </option>
                <option value="uniprotkb_rodents">UniProtKB Rodents</option>
                <option value="uniprotkb_vertebrates">
                  UniProtKB Vertebrates
                </option>
                <option value="uniprotkb_viridiplantae">
                ...
                <option value="uniref100">
                  UniProt Clusters 100% (UniRef100)
                </option>
                <option value="uniref90">
                  UniProt Clusters 90% (UniRef90)
                </option>
                <option value="uniref50">
                  UniProt Clusters 50% (UniRef50)
                </option>
                ...
                <option value="ensembl_covid/Sars_cov_2.ASM985889v3.pep.all">
                  EnsemblCOVID19 protein sequences
                </option>
                <option value="enzymeportal">
                  Enzyme Portal (Sequences from enzyme reports from UniProtKB,
                  PDBe, ChEMBL, ChEBI, REACTOME, Rhea and IntEnz)
                </option>
                <option value="uniparc">
                  UniProt Archive (Sequences from the UniProt Archive UniParc)
                </option>
                <option value="intact">
                  IntAct (Sequences from IntAct interactors)
                </option>
                <option value="imgthlapro">
                  IPD-IMGT/HLA (Immuno Polymorphism Database-International
                  Immunogenetics project/Human Leucocyte Antigen)
                </option>
                <option value="ipdkirpro">
                  IPD-KIR (Immuno Polymorphism Database-Killer-cell
                  Immunoglobulin-like Receptors)
                </option>
                <option value="ipdnhkirpro">
                  IPD-NHKIR (Immuno Polymorphism Database-Killer-cell
                  Immunoglobulin-like Receptors)
                </option>
                <option value="ipdmhcpro">
                  IPD-MHC (Immuno Polymorphism Database-Major Histocompatibility
                  Complex)
                </option>
                <option value="mpro">
                ...
                <option value="mpep">
                  MEROPS-MPEP (Sequences from the peptidase or inhibitor domain
                  sequence only)
                </option>
                <option value="mp">
                ...
                <option value="chembl">
                  ChEMBL (Sequences from a manually curated database of
        ...
        <p style={{ color: "black" }}>
          Enter or paste an amino acid sequence in the box below:
        </p>
