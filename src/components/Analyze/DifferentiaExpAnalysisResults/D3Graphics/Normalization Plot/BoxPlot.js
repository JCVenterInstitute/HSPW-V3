...
//     // window.addEventListener("resize", updateBoxplots);
...
//     //   boxHeight = 600 - boxMargin.top - boxMargin.bottom;
...
//   return <div id={containerId} className="box-plot" ref={boxplotRef} />;
// };
...
const Boxplot = ({ containerId, data }) => {
  ...
  useEffect(() => {
    ...
    sumstats.sort((a, b) => b.median - a.median);
    const topSumstats = sumstats.slice(1, topN);
